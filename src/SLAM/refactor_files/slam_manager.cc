...
#include <pcl/point_types.h>
    ...
    void SlamManager::startSlam(StartSlamParameters params)
    {
        ...
        image_representation_left_thread = std::thread(&SlamManager::process_image_representation_right_thread, this, std::ref(image_representation_right_running), std::ref(image_representation_right_cv));
