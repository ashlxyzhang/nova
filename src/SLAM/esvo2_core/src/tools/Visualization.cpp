...
void Visualization::plot_map(DepthMap::Ptr &depthMapPtr, VisMapType vmType, cv::Mat &img, double max_range,
                             double min_range, double visualization_threshold1, double visualization_threshold2)
{
...
void Visualization::DrawPoint2(double val, double max_range, double min_range, const Eigen::Vector2d &location,
                               cv::Mat &img)
{
    // define the color based on the inverse depth
    //  int index = floor((val - min_range) / (max_range - min_range) * 255.0f);
...
void Visualization::plot_eventMap(std::vector<Event *> &vEventPtr, cv::Mat &eventMap, size_t row, size_t col)
{
