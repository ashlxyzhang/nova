...
- Fixes to Morlet Shutter
  - Although Vulkan does have extensions in place for atomic operations, this is not a feature that is 100% supported. The options would be to increase the minimum specs of NOVA, or figure out a better architecture for handling this data.
